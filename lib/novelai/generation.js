 ...
 * @param {Function} options.onError - The callback function called when an error occurs.
 * @param {Function} options.onOpen - The callback function called when the connection is opened.
 * @returns {AbortSignal} The abort signal for the request.
 */
export const generateStory = async ({
  prompt = '',
  model = TextModels.KAYRA,
  params = {},
  onToken = noop,
  onError = noop,
  onOpen = noop,
...
export const generateImage = async ({
  ...
  for (const [, zipEntry] of Object.entries(zipFile.files)) {
